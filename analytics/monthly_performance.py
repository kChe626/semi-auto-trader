...
class MonthlyPerformance:
    """
    Trading-performance statistics for one calendar month.
    """
...
class MonthlyPerformanceCalculator:
    """
    Groups completed trades by calendar month and
    calculates performance statistics for each month.
    """
    ...
    def calculate(
        ...
        MonthlyPerformanceCalculator._validate_trades(
            normalized_trades
        )
        ...
        monthly_results = [
            MonthlyPerformanceCalculator._calculate_month(
                year=year,
                month=month,
                trades=month_trades,
            )
            for (year, month), month_trades
